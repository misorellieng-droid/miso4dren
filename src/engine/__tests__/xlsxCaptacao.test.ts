...
/** Monta um buffer no mesmo layout gerado por gerarPlanilhaCaptacao (cabeçalho, linha de
 * C, linha de soma, dispositivos) sem passar pela escrita real do arquivo -- simula o que
 * o usuário reimporta depois de editar. */
