...
// O caso de via sem declividade longitudinal (sarjetão em V alimentado
// pelos dois lados, "dente de serra") é tratado pelo módulo dedicado
// src/engine/sarjetao/ — não aqui.
